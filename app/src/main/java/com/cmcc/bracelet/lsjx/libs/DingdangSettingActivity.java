...
public class DingdangSettingActivity extends BaseActivity implements OnClickListener, OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(MapApplication.mContext, "layout", "zyqt_activity_dingdang_setting"));
		initViews();
		loadConfig();
	}
	...
	private void initViews() {
		...
		tpSport = (TimePicker) findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_tp_sport"));
		tpSleep = (TimePicker) findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_tp_sleep"));
		llSleep = (LinearLayout) findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_ll_sleep"));
		spSleep = (LinearLayout) findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_ll_sport"));
		tbSport = (ToggleButton) findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_tb_sport"));
		tbSleep = (ToggleButton) findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_tb_sleep"));

		tbSport.setOnCheckedChangeListener(this);
		tbSleep.setOnCheckedChangeListener(this);

		rbLeft = (RadioButton) findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_radio_left"));
		rbRight = (RadioButton) findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_radio_right"));

		findViewById(MResource.getIdByName(getApplicationContext(), "id", "dingdang_btn_save")).setOnClickListener(this);
	}
	...
	public void  onClick(View v) {
		...
		if (id == MResource.getIdByName(getApplicationContext(), "id", "button_input_bg_back")) {
			this.finish();
		} else if (id == MResource.getIdByName(getApplicationContext(), "id", "dingdang_btn_save")) {
			saveConfig();
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		...
		if (id == MResource.getIdByName(getApplicationContext(), "id", "dingdang_tb_sport")) {
//			tpSport.setEnabled(isChecked);
			enableSport(isChecked);
		} else if (id == MResource.getIdByName(getApplicationContext(), "id", "dingdang_tb_sleep")) {
