...
public class WebViewActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(MapApplication.mContext , "layout", "zyqt_setting_help"));
		initView();
		logic();
	}
	...
	private void logic() {
		...
		mWebView = (WebView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "webview_help"));
...
//		webSettings.setBuiltInZoomControls(true); // 设置出现缩放工具
	...
	private void initView() {
		mTextViewTitle = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "textView_title"));

		mBack = (ImageButton) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "button_input_bg_back"));
