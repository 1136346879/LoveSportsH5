...
import cmccsi.mhealth.portal.sports.activity.MainFragmentActivity;
import cmccsi.mhealth.portal.sports.adapter.MessageAdapter;
import cmccsi.mhealth.portal.sports.adapter.MessageAdapter.ListItemClickHelp;
...
public class MessageFragment extends BackHandledFragment implements OnClickListener, IXListViewListener, ListItemClickHelp {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = inflater.inflate(MResource.getIdByName(MapApplication.mContext, "layout", "zyqt_activity_message"), container, false);
	...
	private void initView() {
		...
		mTextViewTitle.setText(MResource.getIdByName(MapApplication.mContext, "string", "zyqt_message_title"));
		...
		mMainListView = findView(MResource.getIdByName(MapApplication.mContext, "id", "am_main_listview"));
	...
	private void backToMain() {
		if (isInLauncher()) {
			...
			mActivity.overridePendingTransition(MResource.getIdByName(MapApplication.mContext, "anim", "zyqt_slide_in_left"), 
