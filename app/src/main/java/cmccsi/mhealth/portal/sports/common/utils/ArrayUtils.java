 ...
 */
package cmccsi.mhealth.portal.sports.common.utils;
...
public class ArrayUtils {
	 ...
	 * the array must be either a {@link Map.Entry} or an Array,
	 ...
	 *            {@link Map.Entry} or an Array containing at least
	 ...
	 * 
	 * @param array
	 * @return {@code true} if {@link #isEmpty(Object[])} reurn {@code true} or
	 *         the array has a null element
	 */
	public static boolean hasNullObject(Object[] array) {
		if (ArrayUtils.isEmpty(array)) {
			return true;
		}
	 ...
	 *            source
	 * @param indices
	 *            to remove, WILL BE SORTED--so only clones of user-owned
	 *            arrays!
	 * @return new array of same type minus elements specified by unique values
	 *         of {@code indices}
	 * @since 3.0.1
	 */
	 ...
	 * 
	 * @param coll
	 *            {@code HashSet} of {@code Integer}
	 * @return int[]
	 * @since 3.0.1
	 */
	public static int[] extractIndices(HashSet<Integer> coll) {
