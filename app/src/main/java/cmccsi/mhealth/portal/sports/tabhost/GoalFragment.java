...
import cmccsi.mhealth.portal.sports.bean.GoalInfo.GoalType;
...
public class GoalFragment extends BaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(MResource.getIdByName(MapApplication.mContext, "layout", "zyqt_fragment_goal"), container, false);
    ...
    public void findViews() {
        lv_archievementTypes = findView(MResource.getIdByName(MapApplication.mContext, "id", "lv_achievementTypes"));
        tv_showGoal = findView(MResource.getIdByName(MapApplication.mContext, "id", "tv_showGoal"));
    ...
    private void initTitle() {
        TextView tv_title = findView(MResource.getIdByName(MapApplication.mContext, "id", "textView_title"));
        tv_title.setText(MResource.getIdByName(MapApplication.mContext, "string", "zyqt_achievement_title"));
        ImageView iv_backImageView = findView(MResource.getIdByName(MapApplication.mContext, "id", "button_input_bg_back"));
...
//            PreferencesUtils.putString(getActivity(), SharedPreferredKey.GOAL_TYPE, mType);
        ...
        lv_archievementTypes.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                for (int i = 0; i < parent.getCount(); i++) {
                    ...
                    View flag =itemView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "flag"));
                    if (position==i) {
    ...
    private class AchievementTypeAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView==null) {
                ...
                convertView = mInflater.inflate(MResource.getIdByName(MapApplication.mContext, "layout", "zyqt_list_item_goal_type"), null);
                holder.iv_type = (ImageView) convertView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "iv_type"));
                holder.tv_type=(TextView) convertView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "tv_type"));
                holder.flag=convertView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "flag"));
    ...
    private class UploadGoalTypeTask extends AsyncTask<String, Null, Integer>{
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result !=0) {
                Toast.makeText(mActivity, MResource.getIdByName(MapApplication.mContext, "string", "zyqt_MESSAGE_GOAL_UPLAOD_FAILED"),Toast.LENGTH_SHORT).show();
            }
        }
    }
}
