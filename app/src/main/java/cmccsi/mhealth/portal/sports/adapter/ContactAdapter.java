...
public class ContactAdapter extends BaseAdapter {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (view == null || (ViewHolder) view.getTag() == null) {
			...
			view_temp = inflater.inflate(MResource.getIdByName(mContext, "layout", "zyqt_activity_match_contact_items"), parent, false);
			holder.tv_name = (TextView) view_temp.findViewById(MResource.getIdByName(mContext, "id", "tv_friend_name"));
			holder.tv_mobile = (TextView) view_temp.findViewById(MResource.getIdByName(mContext, "id", "tv_friend_mobile"));
			holder.tv_added = (TextView) view_temp.findViewById(MResource.getIdByName(mContext, "id", "tv_friend_is_added"));
			holder.cb_contact = (CheckBox) view_temp.findViewById(MResource.getIdByName(mContext, "id", "cb_friend_add"));
//			holder.rl_match_contact_item = (RelativeLayout) view_temp.findViewById(MResource.getIdByName(mContext, "id", "")rl_match_contact_item);
		}else{
			view_temp = view;
