...
import cmccsi.mhealth.portal.sports.activity.CampaignViewFragment_new;
import cmccsi.mhealth.portal.sports.adapter.MyFragmentAdapter;
...
public class CampaignFragment_new extends BaseFragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = inflater.inflate(MResource.getIdByName(MapApplication.mContext, "layout", "zyqt_activity_racelist1"), container, false);
	...
	private void initView() {
		...
		mTextViewTitle.setText(MResource.getIdByName(MapApplication.mContext, "string", "zyqt_racelist_title"));
		tx_race_now = findView(MResource.getIdByName(MapApplication.mContext, "id", "tx_race_now"));
		tx_race_now.setBackgroundResource(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_weight_top_round"));
		tx_race_soon = findView(MResource.getIdByName(MapApplication.mContext, "id", "tx_race_soon"));
		tx_race_finish = findView(MResource.getIdByName(MapApplication.mContext, "id", "tx_race_finish"));
		...
		mPager = findView(MResource.getIdByName(MapApplication.mContext, "id", "vPager_race"));
		...
		mPager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int arg0) {
				...
				case 0:
					tx_race_now.setBackgroundColor(getResources().getColor(MResource.getIdByName(MapApplication.mContext, "color", "zyqt_white")));
					tx_race_soon.setBackgroundResource(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_weight_top_round"));
					tx_race_finish.setBackgroundColor(getResources().getColor(MResource.getIdByName(MapApplication.mContext, "color", "zyqt_white")));
					break;
				case 1:
					tx_race_now.setBackgroundResource(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_weight_top_round"));
					tx_race_soon.setBackgroundColor(getResources().getColor(MResource.getIdByName(MapApplication.mContext, "color", "zyqt_white")));
					tx_race_finish.setBackgroundColor(getResources().getColor(MResource.getIdByName(MapApplication.mContext, "color", "zyqt_white")));
					break;
				case 2:
					tx_race_now.setBackgroundColor(getResources().getColor(MResource.getIdByName(MapApplication.mContext, "color", "zyqt_white")));
					tx_race_soon.setBackgroundColor(getResources().getColor(MResource.getIdByName(MapApplication.mContext, "color", "zyqt_white")));
					tx_race_finish.setBackgroundResource(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_weight_top_round"));
					break;
				default:
					tx_race_now.setBackgroundColor(getResources().getColor(MResource.getIdByName(MapApplication.mContext, "color", "zyqt_white")));
					tx_race_soon.setBackgroundResource(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_weight_top_round"));
