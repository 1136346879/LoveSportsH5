...
public class CropImageActivity extends MonitoredActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(MResource.getIdByName(getApplicationContext(), "layout", "zyqt_cropimage"));
        mImageView = (CropImageView) findViewById(MResource.getIdByName(getApplicationContext(), "id", "image"));
        ...
        findViewById(MResource.getIdByName(getApplicationContext(), "id", "discard")).setOnClickListener(new View.OnClickListener() {
        ...
        findViewById(MResource.getIdByName(getApplicationContext(), "id", "save")).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                onSaveClicked();
            }
        });
