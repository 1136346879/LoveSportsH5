...
import cmccsi.mhealth.portal.sports.adapter.RankingListAdapter.ViewHolder;
import cmccsi.mhealth.portal.sports.appversion.MResource;
import cmccsi.mhealth.portal.sports.bean.GroupRankInfo;
import cmccsi.mhealth.portal.sports.bean.UserRankInfo;
...
public class ActivityRankListAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(MResource.getIdByName(mContext, "layout", "zyqt_list_item_activity_rank"), null);
			...
			mViewHolder.mTvGroupName = (TextView) convertView.findViewById(MResource.getIdByName(mContext, "id", "textview_group_name"));
