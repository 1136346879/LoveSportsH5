...
//		hRRenderer.setShowGridY(true);
				...
				if (seriesSelection == null) {
					...
					if (seriesSelection.getValue() < 105
						...
						layout_dialog.setBackground(getResources().getDrawable(
								MResource.getIdByName(HRActivity.this, "drawable", "zyqt_hr_normal")));
						textView_comment_dialog.setText("心率处于健康范围，心脏健康状态良好");
						getPopupInstance(MResource.getIdByName(HRActivity.this, "drawable", "zyqt_arrow_normal"));
					} else {
						layout_dialog.setBackground(getResources().getDrawable(
								MResource.getIdByName(HRActivity.this, "drawable", "zyqt_hr_abnormal")));
						if (seriesSelection.getValue() > 105) {
							textView_comment_dialog.setText("存在心动过速风险");
						} else {
							textView_comment_dialog.setText("存在心动过缓风险");
						}
						getPopupInstance(MResource.getIdByName(HRActivity.this, "drawable", "zyqt_arrow_error"));
					}
	...
	private void initialView() {
		...
		hr_time = findView(MResource.getIdByName(this, "id", "hr_time"));
		hr_time.setText(upTime);
		hr_time.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
		
		hr_graph = findView(MResource.getIdByName(this, "id", "hr_graph"));
		...
		button_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				finish();
				overridePendingTransition(MResource.getIdByName(HRActivity.this, "anim", "zyqt_slide_in_left"),
						MResource.getIdByName(HRActivity.this, "anim", "zyqt_silde_out_right"));
			}
		});
		requestData();
	}
