...
//**	private String mCurrentTempFilePath = "";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(MapApplication.mContext , "layout", "zyqt_activity_progressupdate"));
	...
	private void findView() {
		...
		mTextViewFileName = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "tv_fileName"));
		mTextViewFilelength = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "tv_fileLength"));
	}
