...
public class DatePicker extends FrameLayout {
	...
	public DatePicker(Context context, AttributeSet attrs) {
		...
		((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(
				MResource.getIdByName(context, "layout", "zyqt_date_picker"), this, true);
		mDayPicker = (NumberPicker) findViewById(MResource.getIdByName(context, "id", "date_day"));
		mMonthPicker = (NumberPicker) findViewById(MResource.getIdByName(context, "id", "date_month"));
		mYearPicker = (NumberPicker) findViewById(MResource.getIdByName(context, "id", "date_year"));
