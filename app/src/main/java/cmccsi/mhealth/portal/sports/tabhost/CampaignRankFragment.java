...
import cmccsi.mhealth.portal.sports.adapter.CampaignRankListAdapter;
...
public class CampaignRankFragment extends Fragment implements IXListViewListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(MResource.getIdByName(MapApplication.mContext, "layout", "zyqt_fragment_campaign_rank"),
				container, false);
		
		mLvRankList = (XListView) rootView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "lv_campaign_rank_list"));
		mTvRankEmpty = (TextView) rootView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "tv_campaign_rank_empty"));
