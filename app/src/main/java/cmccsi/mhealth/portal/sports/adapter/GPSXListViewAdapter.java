	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(list.get(position).time != null){
			view = View.inflate(context, 
					MResource.getIdByName(context, "layout", "zyqt_title_item"), null);
			TextView textView = (TextView) view.findViewById(MResource.getIdByName(context, "id", "leftmenu_title_textview_company"));
			textView.setText(list.get(position).time);
		}else{
			view = View.inflate(context, 
					MResource.getIdByName(context, "layout", "zyqt_map_list_item"), null);
...
//>>>>>>> .r2858
	...
	private void adapterFindViews(View view) {
		...
		// view.findViewById(MResource.getIdByName(context, "id", "")textview_map_history_date);
		viewHolder.textview_map_history_time = (TextView) view.findViewById(MResource.getIdByName(context, "id", "textview_map_history_time"));
		viewHolder.textview_kilometre = (TextView) view.findViewById(MResource.getIdByName(context, "id", "textview_kilometre"));
		viewHolder.textview_kaluli = (TextView) view.findViewById(MResource.getIdByName(context, "id", "textview_kaluli"));
		viewHolder.textview_duration = (TextView) view.findViewById(MResource.getIdByName(context, "id", "textview_duration"));
		// viewHolder.textview_runtype = (TextView)
		// view.findViewById(MResource.getIdByName(context, "id", "")textview_runtype);
		// viewHolder.rl_date = (RelativeLayout)
		// view.findViewById(MResource.getIdByName(context, "id", "")rl_date);
		// viewHolder.bg = (LinearLayout)
		// view.findViewById(MResource.getIdByName(context, "id", "")linearlayout_null);
		viewHolder.imageViewWalkType = (ImageView) view.findViewById(MResource.getIdByName(context, "id", "imageview_wailtype"));
	}
}
