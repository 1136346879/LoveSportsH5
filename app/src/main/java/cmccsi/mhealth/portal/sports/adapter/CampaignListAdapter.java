...
import cmccsi.mhealth.portal.sports.db.ListActivityTableMetaData;
	...
	public View getView(int arg0, View convertView, ViewGroup parent) {
	      ...
	      if (view == null) {
	    	  view = LayoutInflater.from(context)
	    			  .inflate(MResource.getIdByName(context, "layout", "zyqt_racelist_expandablelist"),
	    			  parent, false);
	    			  holder = new ViewHolder();
	    			  holder.textview_racelist_nowTitle = (TextView) view.findViewById(MResource.getIdByName(context, "id", "textview_racelist_nowTitle"));
	    			  holder.textview_racelist_nowdate = (TextView) view.findViewById(MResource.getIdByName(context, "id", "textview_racelist_nowdate"));
	    			  holder.textview_racelist_nowperson = (TextView) view.findViewById(MResource.getIdByName(context, "id", "textview_racelist_nowperson"));
	    			  view.setTag(holder);
	      }
	      else
	      {
