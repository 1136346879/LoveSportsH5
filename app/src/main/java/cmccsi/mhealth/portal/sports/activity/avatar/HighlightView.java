...
package cmccsi.mhealth.portal.sports.activity.avatar;
...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_camera_crop_width"));
        mResizeDrawableHeight = resources.getDrawable(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_camera_crop_height"));
        mResizeDrawableDiagonal = resources.getDrawable(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_indicator_autocrop"));
    }
    ...
    protected void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (mCircle) {
                ...
                mOutlinePaint.setColor(0xFF2cdaf4);
            } else {
