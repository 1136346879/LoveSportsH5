...
public class GoalInfo {
    ...
    public String getGoalReportInTime(Context context) {
        ...
        if (this.type == GoalType.type4) {
            if (circleNum == 1) {
                if (remainHours < HOUR_PASS_LINE) {
                    report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_First_inhours_huanghe"),String.valueOf(remainHours));
                }else {
                    report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_First_indays_huanghe"),String.valueOf(remainDays));
                }
            } else {
                if (remainHours < HOUR_PASS_LINE) {
                    report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_inhours_huanghe"), String.valueOf(circleNum),
                        String.valueOf(remainHours));
                } else {
                    report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_indays_huanghe"), String.valueOf(circleNum),
        ...
        if (circleNum == 1) {
            if (remainHours < HOUR_PASS_LINE) {
                report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_First_inhours"),
                        type.getName(), String.valueOf(remainHours));
            }else {
                report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_First_indays"),
                        type.getName(), String.valueOf(remainDays));
            }
        } else {
            if (remainHours < HOUR_PASS_LINE) {
                report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_inhours"),
                        type.getName(), String.valueOf(circleNum),
                        String.valueOf(remainHours));
            } else {
                report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_indays"),
                        type.getName(), String.valueOf(circleNum),
                        String.valueOf(remainDays));
            }
        }
    ...
    public String getGoalReportInpercentage(Context context){
        String report = context.getString(MResource.getIdByName(MapApplication.mContext , "string", "zyqt_text_show_goal_percentage"), percentage+"%");
        return report;
    }

    public enum GoalType {
        type0("马拉松", 50 * KILOMETER, MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_icon_achievement_marathon"),
                MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_img_achievement_marathon"),"完成一次马拉松"), type1("北京",
                99 * KILOMETER, MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_icon_achievement_beijing"),
                MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_img_achievement_beijing"),"绕北京一圈"), type2("青海湖",
                540 * KILOMETER, MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_icon_achievement_qinghailake"),
                MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_img_achievement_qinghailake"),"绕青海湖一圈"), type3("台湾",
                913 * KILOMETER, MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_icon_achievement_taiwan"),
                MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_img_achievement_taiwan"),"绕台湾一圈"), type4("黄河",
                5464 * KILOMETER, MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_icon_achievement_huanghe"),
                MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_img_achievement_huanghe"),"黄河徒步行一次"), type5("地球",
                40000 * KILOMETER, MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_icon_achievement_earth"),
                MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_img_achievement_earth"),"绕地球一圈");
