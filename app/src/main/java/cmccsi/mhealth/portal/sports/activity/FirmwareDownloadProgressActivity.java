		...
		public void handleMessage(Message msg) {
			...
			if (!Thread.currentThread().isInterrupted()) {
				...
				case DOWNLOAD_SUCCESSED:
					...
					overridePendingTransition(MResource.getIdByName(MapApplication.mContext, "anim", "zyqt_slide_in_left"), MResource.getIdByName(MapApplication.mContext, "anim", "zyqt_silde_out_right"));
					break;
				case DOWNLOAD_FAILED:
					ToastUtils.showToast_L(getApplicationContext(), "固件下载失败");
					FirmwareDownloadProgressActivity.this.finish();
					overridePendingTransition(MResource.getIdByName(MapApplication.mContext, "anim", "zyqt_slide_in_left"), MResource.getIdByName(MapApplication.mContext, "anim", "zyqt_silde_out_right"));
					break;
				}
