...
//	public static final String PHONESTEP_STOP_NOSAVE_ACTION = "cmccsi.mhealth.portal.sports.phonestep_stop_nosave_action";
	//独立的action 清单文件里记得改啊
	public final static String SC_ACTION = "cmcc.mhealth.portal.sports.service.StepService";
	public static final String STEP_SENDING_ACTION = "cmcc.mhealth.app.sports.STEP_SENDING";
	public static final String UPLOADSTATUS_ACTION = "cmcc.mhealth.app.sports.STEP_UPLOADSTATUS";
	public static final String PHONESTEP_STOP_ACTION = "cmcc.mhealth.app.sports.PHONESTEP_STOP_ACTION";
	public static final String PHONESTEP_STARTUPLOAD_ACTION = "cmcc.mhealth.app.sports.phonestep_startupload_action";
	public static final String PHONESTEP_UPLOAD_ACTION = "cmcc.mhealth.app.sports.phonestep_upload_action";
	public static final String PHONESTEP_STOP_NOSAVE_ACTION = "cmcc.mhealth.app.sports.phonestep_stop_nosave_action";
	...
	public static final String SERVER_NAME = "jiankang.10086.cn/CmccPhr/";//正式环境
  public static final String SERVER_NAME_LOGIN = "http://jiankang.10086.cn/healthcare_service_restful/s/auth/verifyLogin";//正式环境
...
//	public static final String ECG_UPLOAD_URL = "http://112.33.1.161:8081/DADS_HTTP/service/uploadEcgDatas"; // 上传心电数据//测试环境
	...
	*/
	public static String getAppName(Context context) {
		String verName = context.getResources().getText(MResource.getIdByName(MapApplication.mContext, "string", "zyqt_app_name"))
				.toString();
		return verName;
	}     
}
