...
//				String valueTextEmail = value.getEmail();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(MResource.getIdByName(context, "layout", "zyqt_item_searchlist"), null);
			holder.tv = (TextView) convertView.findViewById(MResource.getIdByName(context, "id", "is_tv_searchitem"));
			holder.tv2 = (TextView) convertView.findViewById(MResource.getIdByName(context, "id", "is_tv_searchitem2"));
