...
import cmccsi.mhealth.portal.sports.bean.AreaInfo;
...
public class SettingArea extends BaseActivity implements OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(MapApplication.mContext , "layout", "zyqt_activity_area"));
	...
	private void initViews() {
		mLl_notice = (LinearLayout) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "ll_notice"));
		mTvProvince = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "tv_province"));
		mTvProvince.setOnClickListener(this);
		mTvCity = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "tv_city"));
		mTvCity.setOnClickListener(this);
		// mTextViewCountry = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "zyqt_a")tv_country);
		// mTextViewCountry.setOnClickListener(this);
		// mImageViewLine1 = (ImageView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "zyqt_a")line_area1);
		mIvLine2 = (ImageView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "line_area2"));
		mLvAreaList = (ListView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "lv_area_list"));
	...
	public void onClick(View v) {
		if(v.getId()==MResource.getIdByName(MapApplication.mContext , "id", "tv_province")){
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(mContext).inflate(MResource.getIdByName(MapApplication.mContext , "layout", "zyqt_activity_area_item"), null);
				holder = new ViewHolder();
				holder.mTextViewArea = (TextView) convertView.findViewById(MResource.getIdByName(MapApplication.mContext , "id", "tv_area"));
