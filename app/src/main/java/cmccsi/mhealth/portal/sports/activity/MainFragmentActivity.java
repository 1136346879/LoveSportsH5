...
import cmccsi.mhealth.portal.sports.tabhost.MainGridFragment;
import cmccsi.mhealth.portal.sports.tabhost.MessageFragment;
...
public class MainFragmentActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(this, "layout", "zyqt_activity_main_fragment"));
