...
public class PreLoadResetPwdActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(MapApplication.mContext , "layout", "zyqt_activity_resetpwd"));
	...
	private void initviews() {
		TextView mTextViewTitleBar = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "textView_title"));
		mTextViewTitleBar.setText("密码重置");
		mEditTextPassword = (EditText) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "newpwd_edit_setting"));
		mEditTextPasswordAgain = (EditText) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "newpwd_ag_edit_setting"));

		forget_UpdatePwd_btn_setting = (Button) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "forget_UpdatePwd_btn_setting"));
		button_input_bg_back = (ImageButton) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "button_input_bg_back"));
		button_input_bg_back.setBackgroundDrawable(getResources().getDrawable(MResource.getIdByName(MapApplication.mContext , "drawable", "zyqt_my_button_back")));
...
//		}.execute();
	...
	public void onClick(View v) {
		if(v.getId()==MResource.getIdByName(MapApplication.mContext , "id", "forget_UpdatePwd_btn_setting")){
			//更新密码
