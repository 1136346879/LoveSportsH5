...
public class WiperSwitch extends View implements OnTouchListener{
    ...
    public void init(Context context){  
        //载入图片资源  
        bg_on = BitmapFactory.decodeResource(getResources(), MResource.getIdByName(context, "drawable", "zyqt_switch_on"));
        
        bg_off = BitmapFactory.decodeResource(getResources(), MResource.getIdByName(context, "drawable", "zyqt_switch_off"));
        
        slipper_btn = BitmapFactory.decodeResource(getResources(),MResource.getIdByName(context, "drawable", "zyqt_switch_btn")); 
