...
public class MenuDialog {
	...
	public void showBottomMenuDialog(Activity context, List<CommonBottomMenuItem> items) {
		...
		mMenuDialog = new Dialog(context, MResource.getIdByName(context, "style", "zyqt_dialog_withStatusBar"));
		//mMenuDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
		mMenuDialog.setCanceledOnTouchOutside(true);
		View viewDialog = View.inflate(context, MResource.getIdByName(context, "layout", "zyqt_alertdialog_message"), null);
		mClickToClose = (TextView) viewDialog.findViewById(MResource.getIdByName(context, "id", "am_click_me_to_dismiss_search_dialog"));
		mClickToCancle = (TextView) viewDialog.findViewById(MResource.getIdByName(context, "id", "am_cancle"));
		mGridMenu = (GridView) viewDialog.findViewById(MResource.getIdByName(context, "id", "am_gv1"));
	...
	private class GridAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = this.inflater.inflate(MResource.getIdByName(context, "layout", "zyqt_main_menu_frid"), null);
				holder.iv = (ImageView) convertView.findViewById(MResource.getIdByName(context, "id", "mmf_iv1"));
				holder.tv = (TextView) convertView.findViewById(MResource.getIdByName(context, "id", "mmf_tv1"));
