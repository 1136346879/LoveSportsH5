...
public class CustomDialog extends AlertDialog {
	...
	protected CustomDialog(Context context) {
		super(context, MResource.getIdByName(context, "style", "zyqt_dialog_defult"));
	...
	private void initView() {
		View view = LayoutInflater.from(context).inflate( MResource.getIdByName(context, "layout", "zyqt_dialog_deflut"), null);
		mTvTitle = (TextView) view.findViewById(MResource.getIdByName(context, "id", "tv_dialog_title"));
		mLlContent = (LinearLayout) view.findViewById(MResource.getIdByName(context, "id", "ll_dialog_content"));
		mTvMessage = (TextView) view.findViewById(MResource.getIdByName(context, "id", "tv_message"));
		mLlBtns = (LinearLayout) view.findViewById(MResource.getIdByName(context, "id", "ll_btns"));
		mBtnLeft = (Button) view.findViewById(MResource.getIdByName(context, "id", "btn_ok"));
		mBtnRight = (Button) view.findViewById(MResource.getIdByName(context, "id", "btn_cancel"));
		iv_icon = (ImageView) view.findViewById(MResource.getIdByName(context, "id", "iv_icon"));
	...
	public static CustomDialog showDialog(Context context, int title, int message, boolean isCancelable,
			String leftButton, OnClickListener onLeftClickListener) {
		return showDialog(context, title, message, isCancelable, MResource.getIdByName(context, "drawable", "zyqt_ic_dialog_error"), leftButton,
