...
public class MyTime {
	 ...
	 *            秒
	 */
	public MyTime(int day, int hour, int minute, int second) {
	 ...
	 *            字符串格式的时间
	 */
	public MyTime(String time, String timeSeparator) {
	 ...
	 * @return 运算后的时间
	 */
	public MyTime addTime(MyTime time) {
	 ...
	 * @return 运算后的时间
	 */
	public MyTime subtractTime(MyTime time) {
		MyTime result = new MyTime();
		int down = 0; // 退位标志
