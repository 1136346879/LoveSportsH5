...
import cmccsi.mhealth.portal.sports.adapter.ContactAdapter;
...
import cmccsi.mhealth.portal.sports.bean.ContactInfo;
...
import cmccsi.mhealth.portal.sports.common.utils.ContactUtil;
...
public class MatchContactActivity extends BaseActivity implements OnItemClickListener, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(MapApplication.mContext , "layout", "zyqt_activity_match_contact"));
	...
	public void onClick(View v) {
		if(v.getId()==MResource.getIdByName(MapApplication.mContext , "id", "btn_match_contact_add")){
			if (mContactAdapter != null) {
		...
		}else if(v.getId()==MResource.getIdByName(MapApplication.mContext , "id", "btn_match_contact_cancle")){
			this.finish();
		}
	}
	...
	private void initViews() {
		...
		mLvContacts = (ListView) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "lv_match_contact"));
		mLvContacts.setOnItemClickListener(this);

		Button btnAdd = (Button) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "btn_match_contact_add"));
		btnAdd.setOnClickListener(this);
		Button btnCancle = (Button) findViewById(MResource.getIdByName(MapApplication.mContext , "id", "btn_match_contact_cancle"));
...
//			}
	...
	private class CheckPhoneNumbersTask extends AsyncTask<String, Null, Integer> {
		...
		public CheckPhoneNumbersTask() {
			showProgress(getResources().getString(MResource.getIdByName(MapApplication.mContext, "string", "zyqt_text_wait")));
		}
