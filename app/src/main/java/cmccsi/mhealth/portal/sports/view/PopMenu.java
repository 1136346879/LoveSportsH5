...
public class PopMenu {  
    ...
    public PopMenu(Context context,List<CommonBottomMenuItem> list) {  
        ...
        View view = LayoutInflater.from(context).inflate(MResource.getIdByName(context, "layout", "zyqt_popmenu"), null);  
          
        //设置 listview  
        listView = (ListView)view.findViewById(MResource.getIdByName(context, "id", "lv_popmenu"));  
...
//                LayoutParams.WRAP_CONTENT);  
    ...
    private final class PopAdapter extends BaseAdapter {  
        ...
        public View getView(int position, View convertView, ViewGroup parent) {  
            ...
            ViewHolder holder;  
            if (convertView == null) {  
                convertView = LayoutInflater.from(context).inflate(MResource.getIdByName(context, "layout", "zyqt_simple_imagetext_listitem"), null);  
                holder = new ViewHolder();  
  
                convertView.setTag(holder);  
                holder.groupImage=(ImageView) convertView.findViewById(MResource.getIdByName(context, "id", "imageView1")); 
                holder.groupItem = (TextView) convertView.findViewById(MResource.getIdByName(context, "id", "textView1"));  
