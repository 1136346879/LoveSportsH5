...
import cmccsi.mhealth.portal.sports.adapter.RankingListAdapter;
...
public class RankinglistFragment extends Fragment implements IXListViewListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(MResource.getIdByName(MapApplication.mContext, "layout", "zyqt_fragment_rankinglist"),
				container, false);
		mTvUserOrg = (TextView) rootView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "tv_user_org"));
		mTvStepNum = (TextView) rootView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "tv_userstepnum"));
		mTvRankNo = (TextView) rootView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "tv_userrankno"));
		mLvRankList = (XListView) rootView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "lv_rankinglist"));
		mTvRanknull = (TextView) rootView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "tv_ranknull"));
		ll_self=(LinearLayout)rootView.findViewById(MResource.getIdByName(MapApplication.mContext, "id", "self"));
