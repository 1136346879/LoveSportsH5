...
public class HistorySportActivity extends BaseActivity {
	...
	private RadioButton radiobutton_mounth;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(MapApplication.mContext, "layout", "zyqt_activity_historysport"));
		BaseBackKey("历史统计", this);
		initView();
		initData();
		showProgressDialog(getResources().getString(MResource.getIdByName(MapApplication.mContext, "string", "zyqt_text_wait")),
				HistorySportActivity.this);
		getMsgFromNet();
	}

	private void initView() {
		textView_step = (TextView) findViewById(MResource
				.getIdByName(MapApplication.mContext, "id", "historysport_textview_step"));
		textView_cal = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext, "id", "historysport_textview_cal"));
		textView_length = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext, "id",
				"historysport_textview_length"));
		textView_dialog_step = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext, "id",
				"historysport_dialog_textview_step"));
		textView_dialog_date = (TextView) findViewById(MResource.getIdByName(MapApplication.mContext, "id",
				"historysport_dialog_textview_date"));
		imagebutton_left = (ImageButton) findViewById(MResource.getIdByName(MapApplication.mContext, "id",
				"historysport_imagebutton_left"));
		imagebutton_right = (ImageButton) findViewById(MResource.getIdByName(MapApplication.mContext, "id",
				"historysport_imagebutton_right"));
		loadingImageView = (ImageView) findViewById(MResource.getIdByName(MapApplication.mContext, "id", "loadingImageView"));
		chart = (LinearLayout) findViewById(MResource.getIdByName(MapApplication.mContext, "id", "historysport_chart"));
		dialog = (LinearLayout) findViewById(MResource.getIdByName(MapApplication.mContext, "id", "historysport_dialog"));
		radiogroup = (RadioGroup) findViewById(MResource.getIdByName(MapApplication.mContext, "id", "historysport_RadioGroup"));
		radiobutton_day = (RadioButton) findViewById(MResource.getIdByName(MapApplication.mContext, "id",
				"historysport_radiobutton_day"));
		radiobutton_week = (RadioButton) findViewById(MResource.getIdByName(MapApplication.mContext, "id",
				"historysport_radiobutton_week"));
		radiobutton_mounth = (RadioButton) findViewById(MResource.getIdByName(MapApplication.mContext, "id",
				"historysport_radiobutton_month"));
	}
	...
	private void initData() {
		...
		imagebutton_right.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (0 == NetworkTool.getNetworkState(getApplicationContext())) {
					Toast.makeText(HistorySportActivity.this, getResources().getString(MResource.getIdByName(MapApplication.mContext, "string", "zyqt_MESSAGE_SERVER_EXCEPTION")),
		...
		radiobutton_day.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
		...
		radiobutton_week.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if (isChecked) {
					timeType = "week";
		...
		radiobutton_mounth.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if (isChecked) {
					timeType = "month";
	...
	private void chatLoading() {
		...
		Animation hyperspaceJumpAnimation = AnimationUtils.loadAnimation(this,
				MResource.getIdByName(MapApplication.mContext, "anim", "zyqt_progess_round"));
		// 使用ImageView显示动画
