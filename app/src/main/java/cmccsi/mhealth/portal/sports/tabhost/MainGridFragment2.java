...
import cmccsi.mhealth.portal.sports.pedo.PedometerActivityTest;
	...
	public void onResume() {
        ...
        if(hasECG!=temphasECG){
			...
			if (temphasECG) {
				...
				EcgItem.put("playimg", MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_bg_grid_ecg"));
				EcgItem.put("play", "心境");
...
//        }
    ...
    private void loadDataPage1() {
        addItem(MResource.getIdByName(MapApplication.mContext, "drawable", "zyqt_bg_grid_health"), "走一走", 0);
