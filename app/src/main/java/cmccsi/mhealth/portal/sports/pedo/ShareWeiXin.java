...
import cmccsi.mhealth.portal.sports.common.GetWindowBitmap;
import cmccsi.mhealth.portal.sports.common.ImageUtil;
import cmccsi.mhealth.portal.sports.common.Logger;
import cmccsi.mhealth.portal.sports.common.utils.LogUtils;
...
public class ShareWeiXin implements OnClickListener{
	...
	public void Shared() {
		mCustomDialog = new Dialog(mActivity, MResource.getIdByName(mActivity, "style", "zyqt_dialog_withStatusBar"));
		mCustomDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
		Window window = mCustomDialog.getWindow();
		window.setGravity(Gravity.BOTTOM); // 此处可以设置dialog显示的位置
		window.setWindowAnimations(MResource.getIdByName(mActivity, "style", "zyqt_mystyle")); // 添加动画
		View view = View.inflate(mActivity, MResource.getIdByName(mActivity, "layout", "zyqt_popwindow_wenxininfo_new"), null);
		LinearLayout WxTop = (LinearLayout) view.findViewById(MResource.getIdByName(mActivity, "id", "linear_null"));
		...
		RelativeLayout textview_friends = (RelativeLayout) view.findViewById(MResource.getIdByName(mActivity, "id", "textview_weixin_friends"));
		...
		RelativeLayout textview_quanzi = (RelativeLayout) view.findViewById(MResource.getIdByName(mActivity, "id", "textview_weixin_quan"));
		...
		TextView cancel = (TextView) view.findViewById(MResource.getIdByName(mActivity, "id", "textview_share_cancel"));
...
//		sendTofriends(ImageUtil.toConformBitmapWithNewType(mActivity, null, mBitmapBig,
//				mStrUpdateDate));
		...
		if(top!=null)
		{
			...
			if(isShareWithQR&&mBitmapBig!=null){
		        ...
		        try {  
		            ...
		            bitmap=BitmapFactory.decodeResource(mActivity.getResources(), MResource.getIdByName(mActivity, "drawable", "zyqt_share_qr")); 
...
//			}
	...
	public void onClick(View v) {
		...
		if(v.getId() == MResource.getIdByName(mActivity, "id", "linear_null")){
