...
public class EditTextWithDel extends EditText implements OnFocusChangeListener, TextWatcher {
	...
	private void init(Context mContext) {
		...
		if (mClearDrawable == null) {
			mClearDrawable = getResources().getDrawable(MResource.getIdByName(mContext, "drawable", "zyqt_ui_edittextwithdel_delete")/*MResource.getIdByName(mContext, "drawable", "ui_edittextwithdel_delete")*/);
		}
