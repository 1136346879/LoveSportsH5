...
import cmccsi.mhealth.portal.sports.view.picker.NumberPicker.OnValueChangeListener;
...
public class TimePicker extends FrameLayout implements OnClickListener {
	...
	public TimePicker(Context context, AttributeSet attrs) {
		...
		((LayoutInflater) mContext
				...
				MResource.getIdByName(context, "layout", "zyqt_time_picker"), this, true);
		hourPicker = (NumberPicker) findViewById(MResource.getIdByName(context, "id", "time_hours"));
		minPicker = (NumberPicker) findViewById(MResource.getIdByName(context, "id", "time_minutes"));
		timeSwitcher = (TextSwitcher) findViewById(MResource.getIdByName(context, "id", "time_switcher"));
