...
package cmccsi.mhealth.portal.sports.view.picker;
...
public class NumberPicker extends LinearLayout {
	 ...
	 */
	private static int DEFAULT_LAYOUT_RESOURCE_ID ;
	...
	public NumberPicker(Context context, AttributeSet attrs) {
		this(context, attrs, MResource.getIdByName(context, "attr", "numberPickerStyle"));
	}
	 ...
	 */
	public NumberPicker(final Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs);
		// process style attributes
		DEFAULT_LAYOUT_RESOURCE_ID = MResource.getIdByName(context, "layout", "zyqt_number_picker");
		TypedArray attributesArray = context.obtainStyledAttributes(attrs,
				MResource.getIdsByName(context, "NumberPicker"), defStyle, 0);
		...
		mSolidColor = attributesArray.getColor(
				MResource.getIdByName(context, "styleable", "NumberPicker_solidColor"), 0);

		mSelectionDivider = attributesArray
				.getDrawable(MResource.getIdByName(context, "styleable", "NumberPicker_selectionDivider"));
		...
		mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
				MResource.getIdByName(context, "styleable", "NumberPicker_selectionDividerHeight"),
		...
		mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
				MResource.getIdByName(context, "styleable", "NumberPicker_selectionDividersDistance"),
				defSelectionDividerDistance);

		mMinHeight = attributesArray.getDimensionPixelSize(
				MResource.getIdByName(context, "styleable", "NumberPicker_android_minHeight"), SIZE_UNSPECIFIED);

		mMaxHeight = attributesArray.getDimensionPixelSize(
				MResource.getIdByName(context, "styleable", "NumberPicker_android_maxHeight"), SIZE_UNSPECIFIED);
		...
		mMinWidth = attributesArray.getDimensionPixelSize(
				MResource.getIdByName(context, "styleable", "NumberPicker_android_minWidth"), SIZE_UNSPECIFIED);

		mMaxWidth = attributesArray.getDimensionPixelSize(
				MResource.getIdByName(context, "styleable", "NumberPicker_android_maxWidth"), SIZE_UNSPECIFIED);
		...
		OnClickListener onClickListener = new OnClickListener() {
			public void onClick(View v) {
				...
				if (v.getId() == MResource.getIdByName(context, "id", "increment")) {
		...
		if (!mHasSelectorWheel) {
			mIncrementButton = (ImageButton) findViewById(MResource.getIdByName(context, "id", "increment"));
		...
		// decrement button
		if (!mHasSelectorWheel) {
			mDecrementButton = (ImageButton) findViewById(MResource.getIdByName(context, "id", "decrement"));
		...
		// input text
		mInputText = (EditText) findViewById(MResource.getIdByName(context, "id", "numberpicker_input"));
