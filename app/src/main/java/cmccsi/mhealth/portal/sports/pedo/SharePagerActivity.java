...
public class SharePagerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MResource.getIdByName(getApplicationContext(), "layout", "zyqt_activity_sharepager"));
	...
	public void initView(){
		//findViewById(MResource.getIdByName(getApplicationContext(), "id", "webview_share"));
		ib_back = (ImageButton) findViewById(MResource.getIdByName(getApplicationContext(), "id", "imagebutton_back"));
		ib_back.setVisibility(View.VISIBLE);
		ib_share = (ImageButton) findViewById(MResource.getIdByName(getApplicationContext(), "id", "imagebutton_share"));
		ib_share.setVisibility(View.INVISIBLE);
		wb_share = (WebView) findViewById(MResource.getIdByName(getApplicationContext(), "id", "webview_share"));
	...
	private void initWebView() {
	   ...
	   avatarURL = PreferencesUtils.getString(this,
		...
		Log.e("lkh","stepNum:"+step);
		Log.e("lkh","kcal:"+kcal);
		Log.e("lkh","curTime:"+curTime);
		Log.e("lkh","distance:"+distance);
		String url =" file:///android_asset/zyqt_shareweixin/shareWeiXin.htm"
